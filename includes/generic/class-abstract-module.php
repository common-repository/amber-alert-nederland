...
if (!class_exists("\\leau\\co\\wp_generic\\AbstractModule"))
{
	...
	abstract class AbstractModule
	{
		...
		function AddForm()
		{
			...
			echo "<hr />";
			echo "<i><a href=\"http://www.amberalertnederland.nl\">amber alert nederland</a> | ";
			echo " <a href=\"http://wordpress.org/extend/plugins/amberalert/\">plugin homepage</a> | ";
			echo " <a href=\"http://wordpress.org/tags/wp-favicons?forum_id=10\">plugin forum</a> |";
			echo " disclaimer: de maker van deze plugin heeft geen banden met amberalert (maar ik zal ze verwittigen)";
